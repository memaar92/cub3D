...
/*   Updated: 2023/09/26 16:55:04 by mamesser         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_raycast(t_vars *vars)
{
	...
	vars->ray->mapX = (int)vars->ray->playerX; // set the position within the array we are currently at; for every ray initialized with the player position
	vars->ray->mapY = (int)vars->ray->playerY; // set the position within the array we are currently at; for every ray initialized with the player position
